# venta = [codigo, nombre, tipoActividad, operador, planPago, importe, fechaVenta, horaVenta]

def crearVenta():
    venta = [0, "", 0, "", "", 0, 0, 0]
    return venta

def cargarVenta(venta, codigo, nombre, tipoActividad, operador, planPago, importe, fechaVenta, horaVenta):
    venta[0] = codigo
    venta[1] = nombre
...
def modImporte(venta, nuevoImporte):
